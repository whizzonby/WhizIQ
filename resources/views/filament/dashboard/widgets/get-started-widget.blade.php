<x-filament-widgets::widget>
    <div class="rounded-lg border border-primary-200 bg-white p-6 shadow-sm dark:border-primary-800 dark:bg-gray-900">
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            @foreach ($this->getSteps() as $step)
                <a href="{{ $step['url'] }}"
                   class="group flex items-center gap-3 rounded-lg border p-4 transition hover:border-primary-400 hover:shadow-sm {{ $step['complete'] ? 'border-success-200 bg-success-50 dark:border-success-900 dark:bg-success-950/30' : 'border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/60' }}">
                    ...
                    <div class="min-w-0">
                        <p class="text-sm font-medium text-gray-900 group-hover:text-primary-700 dark:text-gray-100 dark:group-hover:text-primary-300">
                            {{ $step['label'] }}
                        </p>
